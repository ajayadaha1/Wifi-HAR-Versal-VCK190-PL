...
4. ✅ **Full 8‑feature 3‑branch graph HW-validated** (`vck190-2`/morel15): `host_3br feature_graph_3br.xclbin` → **OVERALL: PASS** (mot/brt/phs all bit-accurate, max_abs_err ≤ 1.9e-06). Boot via clean `BOOT_3br_clean.BIN` + JTAG-load (no-Ethernet flow, §10).
