...
typedef struct {
    ...
    XCsi_udp_parser_uio_map maps[ MAX_UIO_MAPS ];
} XCsi_udp_parser_uio_info;

/***************** Variable Definitions **************************************/
static XCsi_udp_parser_uio_info uio_info;
...
static int uio_info_read_name(XCsi_udp_parser_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XCsi_udp_parser_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XCsi_udp_parser_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XCsi_udp_parser_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XCsi_udp_parser_Initialize(XCsi_udp_parser *InstancePtr, const char* InstanceName) {
	XCsi_udp_parser_uio_info *InfoPtr = &uio_info;
