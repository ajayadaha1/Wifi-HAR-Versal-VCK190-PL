...
module mm2s_mm2s_Pipeline_VITIS_LOOP_13_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln19_reg_178;
reg    ap_block_pp0_stage0_11001;
reg   [30:0] i_fu_70;
wire   [30:0] add_ln13_fu_138_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_1;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [31:0] zext_ln13_fu_128_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln13_fu_132_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln13_fu_132_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln13_fu_138_p2 = (ap_sig_allocacmp_i_1 + 31'd1);
...
assign icmp_ln13_fu_132_p2 = (($signed(zext_ln13_fu_128_p1) < $signed(size)) ? 1'b1 : 1'b0);

assign icmp_ln19_fu_144_p2 = ((zext_ln13_fu_128_p1 == add_ln19) ? 1'b1 : 1'b0);
...
assign s_TLAST = icmp_ln19_reg_178;

assign s_TSTRB = 4'd15;

assign zext_ln13_fu_128_p1 = ap_sig_allocacmp_i_1;

endmodule //mm2s_mm2s_Pipeline_VITIS_LOOP_13_1
