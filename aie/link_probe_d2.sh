...
OVERLAY=/group/bcapps/ajayad/master_thesis_rebirth/work/aie/feature_graph/overlay_d2_probe.tcl
echo "PROBE_D2_START $(date)"
rm -rf _x_probe
v++ -l -t hw --platform "$PLATFORM" --temp_dir _x_probe --config system.cfg \
